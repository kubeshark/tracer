...
type TracerProgramSpecs struct {
	BioRead                       *ebpf.ProgramSpec `ebpf:"bio_read"`
	BioRetRead                    *ebpf.ProgramSpec `ebpf:"bio_ret_read"`
	BioRetWrite                   *ebpf.ProgramSpec `ebpf:"bio_ret_write"`
	BioWrite                      *ebpf.ProgramSpec `ebpf:"bio_write"`
...
type TracerPrograms struct {
	BioRead                       *ebpf.Program `ebpf:"bio_read"`
	BioRetRead                    *ebpf.Program `ebpf:"bio_ret_read"`
	BioRetWrite                   *ebpf.Program `ebpf:"bio_ret_write"`
	BioWrite                      *ebpf.Program `ebpf:"bio_write"`
