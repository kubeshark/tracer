...
//
//  Be careful when editing, alignment and padding should be exactly the same in
//  go/c.
//
struct log_message {
  __u32 level;
...
static __always_inline void log_error(void *ctx, __u16 message_code, __u64 arg1,
  ...
  long err = bpf_perf_event_output(ctx, &log_buffer, BPF_F_CURRENT_CPU, &entry,
                                   sizeof(struct log_message));
...
static __always_inline void log_info(void *ctx, __u16 message_code, __u64 arg1,
                                     __u64 arg2, __u64 arg3) {
  struct log_message entry = {};
...
static __always_inline void log_debug(void *ctx, __u16 message_code, __u64 arg1,
                                      __u64 arg2, __u64 arg3) {
  struct log_message entry = {};
